...
## 현재 상태 (2026-03-26)
- 웹: https://fate0-00.vercel.app 라이브
- **최종 QA 완료** (2026-03-26): 레이아웃, 다국어, 플로우, 공유, UX 전수 점검
- 세로 고정 (portrait lock), 한 화면 레이아웃 (100dvh), Android 네비바 48px 패딩
- 프라이버시 페이지 15개 언어 완성
- 히스토리 다국어 재번역 (오미쿠지 rank 키 기반)
- 타로 히스토리 중복 수정 (updateLatestEntry)
- 오미쿠지 흔들기 권한 삭제 → 버튼 전용
- AdSense 승인 대기 중, AdMob은 추후 작업 예정
